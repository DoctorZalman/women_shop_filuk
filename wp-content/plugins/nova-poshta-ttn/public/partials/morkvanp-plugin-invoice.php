...
class MNP_Plugin_Invoice extends MNP_Plugin_Invoice_Controller {
	...
	public function senderFindStreet()
	{
		...
		$this->sender_street = get_option('woocommerce_nova_poshta_sender_address_type') ? get_option('woocommerce_nova_poshta_shipping_method_address') :  $street_name_full;
	...
	public function createInvoice()
	{
		...
		if((strpos($methodid, 'npttn_address_shipping_method')!==false)){
			...
			$this->recipient_address_name = $an[0];
		}
