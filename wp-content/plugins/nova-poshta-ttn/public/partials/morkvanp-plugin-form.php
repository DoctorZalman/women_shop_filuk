  ...
  <div class="tablecontainer">
    <table class="form-table full-width-input">
      <tbody id=tb1>
        ...
        ?>
        <?php formblock_sender( get_option('names'), $wooshipping_settings , get_option('phone'), $descriptionarea ); ?>
       <script>
        ...
        <tbody><?php if(!empty($order_data['customer_note'])){?>
          ...
          <tr>
            <th scope="row">Довідка адреси</th>
              <td><?php echo $order_data['billing']['city'] ; ?>
          <?php echo $order_data['billing']['address_1'] ; ?>
           <?php echo $order_data['billing']['phone'] ; ?></td></tr>
        </tbody>
      </table>
