...
if(isset( $warehouse_billing[1] )){
 ...
 if (strpos($warehouse_billing[1], 'приема-выдачи') !== false) {
   $warehouse_billing[2] = 1;
 }
}
...
<p  style="color:#000">Оновлення може зайняти 10-20 секунд. Для оновлення  бази потрібен дійсний API ключ нової пошти</p>
        </div>';
      }
