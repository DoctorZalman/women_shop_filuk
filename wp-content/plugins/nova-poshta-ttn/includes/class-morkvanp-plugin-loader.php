...
class MNP_Plugin_Loader {
	...
	public function add_settings_fields()
	{
		...
		$args = array(
			...
			array(
				'option_group' => 'morkvanp_options_group',
				'option_name' => 'morkvanp_checkout_auto'
			)
		);
	...
	public function register_settings_fields()
	{
		...
		$args = array(
			...
			array(
				'id' => 'ttn2_example',
				'title' => 'Створювати накладні для усіх варіантів доставок',
				'callback' => array( $this->callbacks, 'morkvanpttn2' ),
				'page' => 'morkvanp_plugin',
				'section' => 'morkvanp_admin_index',
				'args' => array(
					'label_for' => 'zone_example',
			...
			array(
				'id' => 'plus_calc',
				'title' => 'Включати розрахунок вартості доставки до оплати ',
			...
			array(
				...
				'args' => array(
					...
					'class' => 'allsettings forjuridical show'
				)
			),
...
// start auto settings
			...
			array(
				'id' => 'morkvanp_checkout_auto',
				'title' => 'Також якщо обрано метод оплати, за відправку платить відправник:',
				'callback' => array( $this->callbacks, 'morkvanpCheckoutExample1' ),
				'page' => 'morkvanp_plugin',
				'section' => 'morkvanp_admin_index',
				'args' => array(
					'label_for' => 'morkvanp_checkout_auto',
					'class' => 'autosettings allsettings show'
				)
			),
			...
			// array(
			// 	'id' => 'invoice_cron',
			// 	'title' => 'Щогодинний крон оновлення статусів замовлення',
			...
			array(
				...
				array(
					...
					'args' => array(
						'label_for' => 'text_example',
						'class' => 'basesettings allsettings show show'
					)
				),
				array(
					'id' => 'zone_example',
				...
				array(
					...
					'args' => array(
						'label_for' => 'names',
						'class' => 'basesettings allsettings show names'
					)
				),
				array(
					'id' => 'phone',
					...
					'args' => array(
						'label_for' => 'phone',
						'class' => 'basesettings allsettings show phone'
					)
				),
				array(
					'id' => 'region',
					...
					'args' => array(
						'label_for' => 'region',
						'class' => 'basesettings allsettings show region'
					)
				),
				array(
					'id' => 'city',
					...
					'args' => array(
						'label_for' => 'city',
						'class' => 'basesettings allsettings show city'
					)
				),
				array(
					'id' => 'warehouse',
					...
					'args' => array(
						'label_for' => 'warehouse',
						'class' => 'basesettings allsettings show warehouse'
					)
				)
			);
		}
