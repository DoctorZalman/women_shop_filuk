...
class Class_Pi_Dcw_Buy_Now{
    ...
    function __construct($plugin_name){
        ...
        $this->settings = array(
            ...
            array('field'=>'pi_dcw_buy_now_button_loop_position','desc'=>'Position of the button', 'label'=>__('Position of the button'),'type'=>'select', 'default'=>'after_button', 'value'=>array('after_button'=>'After add to cart button', 'before_button'=>'Before add to cart button')),
            array('field'=>'pi_dcw_buy_now_button_loop_redirect','desc'=>'Redirect to cart or checkout page', 'label'=>__('Redirect to cart/checkout page'),'type'=>'select', 'default'=>'checkout', 'value'=>array('checkout'=>'Checkout', 'cart'=>'Cart')),
