...
if(pi_dcw_free_check()){
    ...
    function pi_dcw_free_error_notice() {
        ...
        <div class="error notice">
            <p><?php _e( 'Please Un-Install or deactivate the FREE version of Add to cart direct redirect plugin', 'pi-edd' ); ?></p>
        </div>
        <?php
    }
...
if ( class_exists( 'Pisol_Support' ) ) {
    new Pisol_Support(array(
        'slug'      => 'add-to-cart-direct-checkout-for-woocommerce-pro',
        'version'   => PI_DCW_VERSION,
        'remote_url' => 'https://www.piwebsolution.com/support',
        'site_url'=> get_site_url(),
        'promotion_action'=>"pi-dcw_promotion"
    ));
}
